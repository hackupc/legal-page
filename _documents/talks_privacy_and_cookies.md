---
layout: document
title: "Talks & Workshops Privacy and Cookies Policy"
...
Here are the details of which personal data is collected when you subscribe to be aware of future talks and activities:

- Contact data: E-mail. 
- Prefered language: Catalan, Spanish or English.

Here are the details of which personal data is collected when you contact Hackers@UPC through the web form: 

- Optional Identifying data: Name. 
- Optional contact data: Email. 
- Other information: Text to be send. 


## 3. WHAT WE PROCESS YOUR PERSONAL DATA FOR

When you subscribe to be aware of future talks and activities or/and you contact Hackers@UPC through the web form: 
...
- You may now or at any time in the future object to receive commercial communications about activities, services or products offered by HACKERS AT UPC by sending an email to [info@hackersatupc.org](mailto:info@hackersatupc.org).
